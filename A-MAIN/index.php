  ...
  <body>
    <nav>
      ...
      <ul class="nav-links">
        ...
        <li class="link"><a href="../BOTH/shop.html">Shop</a></li>
        <li class="link"><a href="../BOTH/about-us.html">About us</a></li>
        <li class="link"><a href="../BOTH/contacts.html">Contact</a></li>
      </ul>
        ...
        <div class="header-content">
          <div>
            ...
            <div class="action-btns">
              <a href="../BOTH/shop.html"><button class="btn">Browse</button></a>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="trip">
      <div class="section-container trip-container">
        ...
        <div class="view-all">
          <a href="../BOTH/products.html"><button class="btn">View All</button></a>
    ...
    <footer class="footer">
      <div class="section-container footer-container">
        ...
        <div class="footer-col">
          <h4>Support</h4>
          <p>FAQs</p>
          <a href="../BOTH/termsConditions.html"><p>Terms & Conditions</p></a>
          <a href="../BOTH/privacyPolicy.html"><p>Privacy Policy</p></a>
          <a href="../BOTH/contactUs.html"><p>Contact Us</p></a>
        </div>
        <div class="footer-col">
          <h4>Address</h4>
